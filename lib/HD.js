globalThis.h_ost = 'http://xn--m7r986atvlky4b.cn/';
...
globalThis.jxx = function(bn, url) {
    let html1 = request('http://xn--m7r986atvlky4b.cn/apptov5/v2/parsing/proxy', {
        body: {
            'play_url': url,
            'key': bn
        },
    ...
    lazy: $js.toString(() => {
        ...
        if (!murl.includes('http')) {
            input = {
                ...
                url: input,
                jx: 0,
                danmaku: 'http://1.94.221.189:88/algorithm.php?url=' + parts[1]
            };
        } else {
            input = {
                parse: 0,
