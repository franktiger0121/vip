var rule = {
    ...
    class_name: '电视&电影&动漫&综艺&少儿&纪录',
    class_url: 'tv&movie&cartoon&variety&child&doco',
    limit: 20,
    play_parse:true,
    // play_parse:true,
 lazy: $js.toString(() => {
    ...
    // 发起请求并解析返回的 JSON 数据
    let response = JSON.parse(request("http://115.231.220.139:8555/api/index?parsesId=2&appid=10000&videoUrl=" + input));
    ...
    二级: $js.toString(() => {
        ...
        VOD.vod_play_from = yg.length < 1 ? "qq" : "qq";
